...
void test_c8_load_quirks_WithValidQuirks(void) {
    int result = c8_load_quirks(&c8, "vmcsj");
    TEST_ASSERT_EQUAL_INT(0, result);
    TEST_ASSERT_EQUAL_INT(C8_FLAG_QUIRK_VF_RESET, c8.flags & C8_FLAG_QUIRK_VF_RESET);
    TEST_ASSERT_EQUAL_INT(C8_FLAG_QUIRK_MEMORY, c8.flags & C8_FLAG_QUIRK_MEMORY);
    TEST_ASSERT_EQUAL_INT(C8_FLAG_QUIRK_CLIPPING, c8.flags & C8_FLAG_QUIRK_CLIPPING);
    TEST_ASSERT_EQUAL_INT(C8_FLAG_QUIRK_JUMPING, c8.flags & C8_FLAG_QUIRK_JUMPING);
    TEST_ASSERT_EQUAL_INT(C8_FLAG_QUIRK_SHIFTING, c8.flags & C8_FLAG_QUIRK_SHIFTING);
}
